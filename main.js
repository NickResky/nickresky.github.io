...
var main_page_2_service_1 = __webpack_require__(/*! ./services/main-page-2.service */ "./src/app/services/main-page-2.service.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [
                ...
                main_page_2_service_1.MainPageService2,
...
/***/ "./src/app/classes/main-page-section-2.ts":
/*!************************************************!*\
  !*** ./src/app/classes/main-page-section-2.ts ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var MainPageSection2 = /** @class */ (function () {
    function MainPageSection2() {
    }
    return MainPageSection2;
}());
exports.MainPageSection2 = MainPageSection2;
...
var MainPageComponent = /** @class */ (function () {
    ...
    MainPageComponent.prototype.ngOnInit = function () {
        ...
        this.modelService.language.subscribe(function (language) {
            _this.languageIsEnglish = _this.modelService.language.getValue() === 'EN' ? true : false;
        });
        ...
        this.mainPageListShortId = zenkit_collections_1.ZenkitCollections.home.shortId;
        this.modelService.getMainPageSections2().then(function (mainPageSections) {
            _this.titleSection = _.head(mainPageSections);
            _this.sections = mainPageSections.slice(1);
            ...
            setTimeout(function () {
                ...
                var blockElements = document.getElementsByClassName('main-page-block');
                var blockElementsArray = Array.from(blockElements);
                blockElementsArray.forEach(function (el) {
                    intersectionObserver2.observe(el);
                });
                blockElementsArray.forEach(function (el) {
                    if (_this.isIntersecting(el)) {
    ...
    MainPageComponent.prototype.isIntersecting = function (element) {
    ...
    MainPageComponent.prototype.setVisiblityAfterTimeout = function (element, timeout) {
        setTimeout(function () {
    ...
    //   }
    // }
    MainPageComponent.prototype.scrollIntoView = function (elementId) {
...
/***/ "./src/app/services/main-page-2.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/main-page-2.service.ts ***!
  \*************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var main_page_section_2_1 = __webpack_require__(/*! ./../classes/main-page-section-2 */ "./src/app/classes/main-page-section-2.ts");
var zenkit_collections_1 = __webpack_require__(/*! ./../shared/constants/zenkit-collections */ "./src/app/shared/constants/zenkit-collections.ts");
var dynamic_content_service_1 = __webpack_require__(/*! ./dynamic-content.service */ "./src/app/services/dynamic-content.service.ts");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var _ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
var MainPageService2 = /** @class */ (function () {
    function MainPageService2(dynamicContentService) {
        this.dynamicContentService = dynamicContentService;
    }
    MainPageService2.prototype.getMainPageSections = function () {
        var _this = this;
        return this.dynamicContentService
            .fetchAndTransformZenkitListData(zenkit_collections_1.ZenkitCollections.sections.shortId)
            .then(function (zenkitListData) {
            var mainPageSections = _.map(zenkitListData.entries, function (modifiedEntry) {
                var mainPageSection = new main_page_section_2_1.MainPageSection2();
                ...
                var image = _.head(modifiedEntry.image);
                if (image) {
                    mainPageSection.image = _this.dynamicContentService.getFileSrc(_.get(image, ['shortId']), zenkit_collections_1.ZenkitCollections.sections.shortId);
                }
                var image_mobile = _.head(modifiedEntry.image_mobile);
                if (image_mobile) {
                    // tslint:disable-next-line:max-line-length
                    mainPageSection.image_mobile = _this.dynamicContentService.getFileSrc(_.get(image_mobile, ['shortId']), zenkit_collections_1.ZenkitCollections.sections.shortId);
                }
                var image2_ge = _.head(modifiedEntry.image2_ge);
                if (image2_ge) {
                    // tslint:disable-next-line:max-line-length
                    mainPageSection.image2_ge = _this.dynamicContentService.getFileSrc(_.get(image2_ge, ['shortId']), zenkit_collections_1.ZenkitCollections.sections.shortId);
                }
                var image2_en = _.head(modifiedEntry.image2_en);
                if (image2_en) {
                    // tslint:disable-next-line:max-line-length
                    mainPageSection.image2_en = _this.dynamicContentService.getFileSrc(_.get(image2_en, ['shortId']), zenkit_collections_1.ZenkitCollections.sections.shortId);
                }
                return mainPageSection;
            });
    ...
    MainPageService2 = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [dynamic_content_service_1.DynamicContentService])
    ], MainPageService2);
    return MainPageService2;
}());
exports.MainPageService2 = MainPageService2;
...
var main_page_2_service_1 = __webpack_require__(/*! ./main-page-2.service */ "./src/app/services/main-page-2.service.ts");
var ModelService = /** @class */ (function () {
    ...
    //     return observer;
    // });
    function ModelService(platformId, mainPageService, mainPageService2, stageService, coursesService, teamService, locationsService, contactService, currentService, imprintService, scheduleService) {
        this.platformId = platformId;
        this.mainPageService = mainPageService;
        this.mainPageService2 = mainPageService2;
        ...
        this.language = new rxjs_1.BehaviorSubject('GE');
    }
    ...
    ModelService.prototype.getMainPageSections2 = function () {
        var _this = this;
        if (_.isNil(this.mainPageSections)) {
            this.mainPageSections = this.mainPageService2.getMainPageSections();
            return this.mainPageSections;
        }
        return new Promise(function (resolve, reject) {
            return resolve(_this.mainPageSections);
        });
    };
...
exports.ZenkitCollections = {
    ...
    sections: {
        shortId: '7L87PV4Zg',
        requiredElements: required_elements_1.RequiredElements.sections
    },
    current: {
        shortId: 'S1PZ5AbcZ',
...
module.exports = "<div class=\"navbar-container\">\r\n  <div class=\"main-content-container main-content-container-padding\">\r\n    <div class=\"main-content\">\r\n      <div class=\"loading-animation-container\" *ngIf=\"isBrowser\">\r\n        <div class=\"loader-container\" [ngClass]=\"[pageLoaded ? 'hide' : '']\">\r\n          <div class=\"loader-circle\"></div>\r\n          <div class=\"loader-line-mask\">\r\n            <div class=\"loader-line\"></div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class=\"title-container\" *ngIf=\"pageIsHome\" [ngClass]=\"[scrolledToTop ? 'show' : 'hide']\">\r\n          <div class=\"title\" routerLink=\"/\"></div>\r\n        </div>\r\n        <div class=\"navbar-non-mobile-container\" [ngClass]=\"[pageLoaded ? 'show' : '']\" *ngIf=\"pageIsHome\">\r\n          <div class=\"navbar-non-mobile\">\r\n            <div *ngFor=\"let pageSection of pageSections\" class=\"navbar-non-mobile-element\" [id]=\"pageSection.navigation_dom_id\" [ngClass]=\"[pageSection.isHighlightedInNavigation ? 'active' : '']\" (click)=\"scrollIntoView(pageSection.ankerId)\">{{languageIsEnglish ? pageSection.title_en : pageSection.title_ge}}</div>\r\n            <div class=\"navbar-non-mobile-element language-container\" (click)=\"switchLanguage()\">\r\n                <i class=\"language-icon fas fa-globe\"></i>\r\n                <span class=\"language-label\">{{languageIsEnglish ? 'DE' : 'EN'}}</span>\r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"logo-container\" [ngClass]=\"[pageLoaded ? 'show' : '', false ? '' : 'background-active']\">\r\n          <div class=\"logo-container-inner\">\r\n            <div class=\"logo\" routerLink=\"/\" (click)=\"scrollIntoView('anker-title')\"></div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"navbar\" [ngClass]=\"isMobileNavOpen === true ? 'mobile-nav-open': ''\">\r\n        <div class=\"navbar-menu-icon-container language-container\" (click)=\"switchLanguage()\" *ngIf=\"isBrowser\">\r\n            <i class=\"language-icon fas fa-globe\"></i>\r\n            <span class=\"language-label\">{{languageIsEnglish ? 'DE' : 'EN'}}</span>\r\n        </div>\r\n        <div class=\"navbar-menu-icon-container\" (click)=\"toggleMobileNav()\" *ngIf=\"isBrowser\">\r\n          <div class=\"navbar-menu-icon\">\r\n            <div class=\"bar bar1\"></div>\r\n            <div class=\"bar bar2\"></div>\r\n            <div class=\"bar bar3\"></div>\r\n          </div>\r\n        </div>\r\n        <div class=\"navbar-page-overlay\" [ngClass]=\"isMobileNavOpen === true ? 'show': ''\" (click)=\"closeMobileNav()\">\r\n\r\n        </div>\r\n        <div class=\"navbar-navigation\">\r\n          <a *ngFor=\"let pageSection of pageSections\" class=\"navbar-navigation-link\" (click)=\"scrollIntoView(pageSection.ankerId)\">\r\n            {{languageIsEnglish ? pageSection.title_en : pageSection.title_ge}}\r\n          </a>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n\r\n</div>"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(modelService, router) {
        ...
        this.updateNavigationIsRunning = false;
        this.pageSections = [];
    }
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.modelService.getMainPageSections2().then(function (sections) {
            _this.pageSections = sections.slice(1);
        });
        this.modelService.isPageLoaded().subscribe(function (x) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.modelService.isPlatformBrowser()) return [3 /*break*/, 2];
                        this.pageLoaded = x;
                    ...
                    case 2:
                        if (this.modelService.isPlatformBrowser()) {
                            window.addEventListener('scroll', function (e) {
                                _this.setScrollPositions();
                                _this.updateHighlightedPageSection();
                            });
                            window.addEventListener('resize', function (e) {
                                _this.setScrollPositions();
                                _this.setPageSectionPositions();
                                _this.updateHighlightedPageSection();
                            });
                        }
                        return [2 /*return*/];
    ...
    HeaderComponent.prototype.timeout = function (time) {
    ...
    HeaderComponent.prototype.setScrollPositions = function () {
        this.last_known_scroll_position = window.scrollY;
        console.log(window.scrollY);
        this.scrolledToTop = this.last_known_scroll_position === 0;
        var lastElement = this.pageSections[this.pageSections.length - 1];
        if (lastElement.scrollYEnd) {
            this.scrolledToBottom = ((window.innerHeight + window.scrollY) >= lastElement.scrollYEnd);
        }
    };
    HeaderComponent.prototype.setPageSectionPositions = function () {
        this.pageSections.forEach(function (pageSection) {
            var element = document.getElementById(pageSection.ankerId);
            if (element) {
    ...
    HeaderComponent.prototype.updateHighlightedPageSection = function () {
        var _this = this;
        this.pageSections.forEach(function (pageSection) {
            if (pageSection.scrollYStart && pageSection.scrollYEnd) {
                if (_this.last_known_scroll_position >= pageSection.scrollYStart
                    && _this.last_known_scroll_position <= pageSection.scrollYEnd
            ...
            if (_this.scrolledToBottom) {
                _this.pageSections[_this.pageSections.length - 1].isHighlightedInNavigation = true;
            }
        });
    };
    ...
    HeaderComponent.prototype.switchLanguage = function () {
        var nextLanguage = this.languageIsEnglish ? 'GE' : 'EN';
...
module.exports = "<div class=\"imprint-content-container main-content-container main-content-container-padding\">\r\n  <div class=\"imprint-content main-content\">\r\n    <h1  class=\"imprint-heading\">{{languageIsEnglish ? 'Imprint' : 'Impressum'}}</h1>\r\n    <div class=\"imprint-general-description\" [innerHTML]='languageIsEnglish ? contact.imprint_en : contact.imprint_ge' *ngIf=\"contact\"></div>\r\n  </div>\r\n</div>\r\n"
...
module.exports = "<div class=\"imprint-content-container main-content-container main-content-container-padding\">\r\n  <div class=\"imprint-content main-content\">\r\n    <h1  class=\"imprint-heading\">{{languageIsEnglish ? 'Privacy' : 'Datenschutz'}}</h1>\r\n    <div class=\"imprint-general-description\" [innerHTML]='languageIsEnglish ? contact.privacy_en : contact.privacy_ge' *ngIf=\"contact\"></div>\r\n  </div>\r\n</div>\r\n"
