...
var MainPageComponent = /** @class */ (function () {
    ...
    MainPageComponent.prototype.ngOnInit = function () {
        ...
        var serviceBoxContainer = document.getElementById('services-img-container');
        var intersectionObserver = new IntersectionObserver(function (entries) {
            if (entries[0].isIntersecting === true) {
                console.log('Element is fully visible in screen');
                var children = Array.from(serviceBoxContainer.children);
                var index_1 = 0;
                children.forEach(function (element) {
                    _this.setVisiblityAfterTimeout(element, index_1 * 400);
                    index_1++;
                });
            }
        }, { threshold: [0.5] });
        // intersectionObserver.observe(serviceBoxContainer);
